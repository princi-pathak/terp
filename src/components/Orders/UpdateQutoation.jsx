...
const UpdateQutoation = () => {
  ...
  const [state, setState] = useState({
    ...
    load_date:
      from?.load_Before_date && !isNaN(new Date(from.load_Before_date))
      ...
      <Card title={`Quotation Management / Update Form`}>
        ...
        <div className="row py-4 px-4">
          <div className="col-lg-4">
            <b> Total NW : </b>
          {(+summary?.Net_Weight || 0).toLocaleString()}
          </div>
          <div className="col-lg-4">
            <b> Total FOB : </b>
        {(+summary?.FOB || 0).toLocaleString()}
          </div>
          <div className="col-lg-4">
            <b> Total Commission : </b>
          {(+summary?.Commission || 0).toLocaleString()}
          </div>
          <div className="col-lg-4">
            <b> Total GW : </b>
           {(+summary?.Gross_weight || 0).toLocaleString()}
          </div>
          <div className="col-lg-4">
            <b> Total Freight : </b>
           {(+summary?.Freight || 0).toLocaleString()}
          </div>
          <div className="col-lg-4">
            <b> Total Rebate : </b>
           {(+summary?.rebate || 0).toLocaleString()}
          </div>
          <div className="col-lg-4">
            <b> Total Box : </b>
           {(+summary?.Box || 0).toLocaleString()}
          </div>
          <div className="col-lg-4">
            <b> Total CNF : </b>
           {(+summary?.CNF || 0).toLocaleString()}
          </div>
          <div className="col-lg-4">
            <b> Total Profit : </b>

  ...
  const columns = useMemo(
    () => [
...

      {
        ...
        accessor: (a) => (
          <div>
            <Barcode width={0.8} height={30} value={a.ean_code} />
          </div>
        ),
      },

      {
        ...
        accessor: (a) => <div>{a.ean_packaging_weight}</div>,
      },

      {
        Header: "Net Weight",
        accessor: (a) => <div>{a.ean_net_weight}</div>,
      },

      {
        Header: "Gross Weight",
        accessor: (a) => <div>{a.ean_gross_weight}</div>,
      },
        ...
        accessor: (a) => (
          ...
          >
            <input
              ...
              onClick={() => updateEanStatus(a.ean_id)}
              value={a.status}
              type="checkbox"
            />
            <span>
